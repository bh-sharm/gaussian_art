...
# bharat starts
#SIESTA=../../../siesta
SIESTA=/global/software/siesta-4.0b-rh6/bin/siesta
# bharat ends
#
...
#
#----------------------------------------------------------------------------
REFERENCE_DIR?=/global/software/siesta-4.0b-rh6/Tests/Reference
REFERENCE_CHECKER?=/global/software/siesta-4.0b-rh6/Tests/cmp_digest.sh
#
label=work
#
...
completed_$(label):
	...
	@for i in `cat $(name).pseudos` ; do \
          ...
          ln /global/software/siesta-4.0b-rh6/Tests/Pseudos/$$i.psf $(label)/$$i.psf ;\
         done
